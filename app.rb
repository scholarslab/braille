...
post '/braille' do
	...
	if input_file.size > 0
		...
		begin
			...
			output_string = `./bin/xml2brl -p -f /app/share/liblouisxml/lbx_files/canonical.cfg,/app/share/liblouis/tables/ #{input_file.path} #{output_file.path}`
...
##Create the input and output files for the system call
	...
	if input_file.size > 0
		...
		begin
			...
			##Make the system call
			output_string = `./bin/xml2brl -p -f ./share/liblouisxml/lbx_files/canonical.cfg #{input_file.path} #{output_file.path}`
